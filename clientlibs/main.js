...
app.registerExtension({
    ...
    async nodeCreated(node) {
        ...
        if(nodeClass === RUNWARE_NODE_TYPES.IMAGEINFERENCE) {
            ...
            useParameterToggleHandler(node);
