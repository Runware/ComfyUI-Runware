...
app.registerExtension({
    ...
    async nodeCreated(node) {
        ...
        } else if(nodeClass === RUNWARE_NODE_TYPES.BRIAPROVIDERKEYPOINTS) {
            briaProviderKeyPointsToggleHandler(node);
        }
