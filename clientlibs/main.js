...
app.registerExtension({
    ...
    async nodeCreated(node) {
        ...
        } else if(nodeClass === RUNWARE_NODE_TYPES.AUDIOINFERENCESPEECHVOICES) {
            audioInferenceSpeechVoicesToggleHandler(node);
        ...
        } else if(nodeClass === RUNWARE_NODE_TYPES.IMAGEINFERENCESETTINGSMOODBOARDS) {
