class apiManager:
    ...
    DESCRIPTION = "API Managers is a Runware Utility That helps you define or change your API Key From The ComfyUI Interface Without having to adjust the env file locally."
    CATEGORY = "Runware"
    RETURN_TYPES = ()