        ...
        return {
            ...
            "optional": {
                ...
                "advancedFeatures": ("RUNWAREIMAGEINFERENCEADVANCEDFEATURES", {
                    "tooltip": "Connect Runware Image Inference Advanced Features for layerDiffuse (transparency) and hiresFix (two-stage high-res).",
                }),
            }
        }
        ...
        if providerSettings is not None:
            ...
            if isinstance(providerSettings, dict):
                ...
                if any(key in providerSettings for key in ["alibaba", "bytedance", "klingai", "openai", "pixverse", 
                                                          "bria", "lightricks", "luma", "minimax", "runway", "vidu", "elevenlabs", "bfl", "xai", "recraft", "sourceful"]):
