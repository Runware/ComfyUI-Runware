...
Provides Ultralytics parameters for image inference (ultralytics.*)
Parameters are passed to genConfig["ultralytics"] like settings.
"""

from typing import Dict, Any


class RunwareUltralyticsInputs:
    """Runware Image Inference Ultralytics - Ultralytics parameters for image inference"""
    ...
    DESCRIPTION = "Configure Ultralytics parameters for Runware Image Inference. Passed as genConfig.ultralytics (like settings)."
    RETURN_TYPES = ("RUNWAREULTRALYTICSINPUTS",)
    RETURN_NAMES = ("Ultralytics",)
    FUNCTION = "create_ultralytics_inputs"
    CATEGORY = "Runware"

    def create_ultralytics_inputs(self, **kwargs) -> tuple[Dict[str, Any]]:
        """Create Ultralytics parameters dict"""
...
NODE_CLASS_MAPPINGS = {
    "RunwareUltralyticsInputs": RunwareUltralyticsInputs,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "RunwareUltralyticsInputs": "Runware Image Inference Ultralytics",
}
